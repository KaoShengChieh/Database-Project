...
public class HistoryList extends JPanel {
	...
	public void makeHistoryList(List<Query> historyList) {
...
//			String hotelAddress = orderList.get(i).hotelAddress;
			...
			Object[] data = { bookid, hotelid, singleNum, doubleNum, quadNum, checkin, checkout, price, address};
	...
	public HistoryList() {
		...
		JLabel lblTitle = new JLabel("You booking history");
